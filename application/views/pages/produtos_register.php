            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <h5 class="card-title">Preencha os dados do novo produto</h5>
								 ...
								 <div class="row">
									<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="nome" name="nome" placeholder="Escreva o produto">
											</div>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control monetario" name="preco" placeholder="Escreva o preço">
											</div>
                  </div>
                  ...
                  <button type="buttom" class="btn btn-info float-right" onclick="cadastra_produto($('#cadastra_produto').serialize())">Salvar</button>
                </div>
								<?php //echo form_close(); ?>
              </div>
							</form>
